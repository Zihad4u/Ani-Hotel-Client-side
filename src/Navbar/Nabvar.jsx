...
function Navbar() {
    ...
    const headNav = <>
        ...
        <li className="font-semibold" ><NavLink to="/myBookings" >My Bookings</NavLink></li>
        <li className="font-semibold" ><NavLink to="/rooms" >Rooms</NavLink></li>
    ...
    return (
        ...
        <div className="navbar bg-base-100" >
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl">Ani Hotel</a>
            </div>
